...
@section('content')
    <form action="/roles/{{$roles->id}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-3">
            <label for="" class="form-label">Nombre</label>
            <input type="text" id="nombre" name="nombre" class="form-control" value="{{$roles->nombre}}" >
          </div>
        ...
        <div class="form-group">
          ...
          @endif
          <img src = "{{asset('archivos/'.$roles->ruta)}}" height=150 width=150>
